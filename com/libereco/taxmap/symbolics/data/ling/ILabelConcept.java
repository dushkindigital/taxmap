...
/**
 * An interface for the atomic concept of a label. 
 * Atomic concept of label corresponds to the natural language token.
 * In case of unigram tokens, the correspondence is one-to-one; 
 * In case of multiword tokens, the entire n-gram can be represented as a single atomic concept.
 *
 */
